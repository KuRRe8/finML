...
while(True):
    ...
    the_pipe2 = Pipeline([
        ...
        ('estimator2', Lasso()) #iterative solution
    ])
    ...
    'estimator2__alpha': [0.01, 8.0, 10.0] + list(np.arange(0.1, 3.1, 0.1)),
    ...
    prediction_set2[TARGET_NAME].to_csv('out\\approach2_linear_lasso.csv', index=False)
    prediction_set2.to_csv('out\\approach2_linear_lasso_all.csv', index=False)
...
while True:
    ...
    the_pipe1 = Pipeline([
        ...
        ('estimator1', Lasso()) #iterative solution
    ])
    ...
    param_grid1 = {
    'estimator1__alpha': [0.01, 8.0, 10.0] + list(np.arange(0.1, 3.1, 0.1)),
    ...
    prediction_set1[TARGET_NAME].to_csv('out\\approach1_linear_lasso.csv', index=False)
    prediction_set1.to_csv('out\\approach1_linear_lasso_all.csv', index=False)
...
while True:
    ...
    the_pipe0 = Pipeline([
        ...
        ('estimator0', Lasso()) #iterative solution
    ])
    ...
    param_grid0 = {
    'estimator0__alpha': [0.01, 8.0, 10.0] + list(np.arange(0.1, 3.1, 0.1)),
    ...
    prediction_set0[TARGET_NAME].to_csv('out\\approach0_linear_lasso.csv', index=False)
    prediction_set0.to_csv('out\\approach0_linear_lasso_all.csv', index=False)
