...
filehandler = logging.FileHandler('out\\tree_RF.log')
...
while(True):
    ...
    the_pipe2 = Pipeline([
        ...
        ('estimator2', RandomForestRegressor()) #search solution
    ])
    ...
    'estimator2__n_estimators': [10, 100],
    'estimator2__max_depth': [10, 100],
    'estimator2__min_samples_split': [ 10, 20],
    'estimator2__min_samples_leaf': [10],
    ...
    prediction_set2[TARGET_NAME].to_csv('out\\approach2_tree_RF.csv', index=False)
    prediction_set2.to_csv('out\\approach2_tree_RF_all.csv', index=False)
...
while True:
    ...
    the_pipe1 = Pipeline([
        ...
        ('estimator1', RandomForestRegressor()) #search solution
    ])
    ...
    param_grid1 = {
    'estimator1__n_estimators': [10, 100],
    'estimator1__max_depth': [10, 100],
    'estimator1__min_samples_split': [ 10, 20],
    'estimator1__min_samples_leaf': [10],
    ...
    prediction_set1[TARGET_NAME].to_csv('out\\approach1_tree_RF.csv', index=False)
    prediction_set1.to_csv('out\\approach1_tree_RF_all.csv', index=False)
...
while True:
    ...
    the_pipe0 = Pipeline([
        ...
        ('estimator0', RandomForestRegressor()) #search solution
    ])
    ...
    param_grid0 = {
    'estimator0__n_estimators': [10, 100],
    'estimator0__max_depth': [10, 100],
    'estimator0__min_samples_split': [ 10, 20],
    'estimator0__min_samples_leaf': [10],
    ...
    prediction_set0[TARGET_NAME].to_csv('out\\approach0_tree_RF.csv', index=False)
    prediction_set0.to_csv('out\\approach0_tree_RF_all.csv', index=False)
