...
filehandler = logging.FileHandler('out\\XGBoost.log')
...
while(True):
    ...
    the_pipe2 = Pipeline([
        ...
        ('estimator2', XGBRegressor(tree_method='gpu_hist')) 
    ])
    ...
    'estimator2__n_estimators': [50, 100],
    'estimator2__device': ['gpu'],
    ...
    prediction_set2[TARGET_NAME].to_csv('out\\approach2_XGBoost.csv', index=False)
    prediction_set2.to_csv('out\\approach2_XGBoost_all.csv', index=False)
...
while True:
    ...
    the_pipe1 = Pipeline([
        ...
        ('estimator1', XGBRegressor(tree_method='gpu_hist')) 
    ])
    ...
    param_grid1 = {
    'estimator1__n_estimators': [50, 100],
    'estimator1__device': ['gpu'],
    ...
    prediction_set1[TARGET_NAME].to_csv('out\\approach1_XGBoost.csv', index=False)
    prediction_set1.to_csv('out\\approach1_XGBoost_all.csv', index=False)
...
while True:
    ...
    the_pipe0 = Pipeline([
        ...
        ('estimator0', XGBRegressor(tree_method='gpu_hist')) 
    ])
    ...
    param_grid0 = {
    'estimator0__n_estimators': [50, 100],
    'estimator0__device': ['gpu'],
    ...
    prediction_set0[TARGET_NAME].to_csv('out\\approach0_XGBoost.csv', index=False)
    prediction_set0.to_csv('out\\approach0_XGBoost_all.csv', index=False)
