...
while(True):
    ...
    the_pipe2 = Pipeline([
        ...
        ('estimator2', MLPRegressor()) #search solution
    ])
    ...
    param_grid2 = {
    'imputer2__strategy': ['mean', 'median'],
    'estimator2__activation': ['tanh', 'relu'],
    'estimator2__solver': ['sgd', 'adam'],
    'estimator2__alpha': [0.0001, 0.001, 0.01],
    'estimator2__learning_rate': ['adaptive'],
    'estimator2__verbose': [True]
    ...
    prediction_set2[TARGET_NAME].to_csv('out\\approach2_neural_MLP.csv', index=False)
    prediction_set2.to_csv('out\\approach2_neural_MLP_all.csv', index=False)
...
while True:
    ...
    the_pipe1 = Pipeline([
        ...
        ('estimator1', MLPRegressor()) #search solution
    ])
    ...
    param_grid1 = {
    'estimator1__activation': ['tanh', 'relu'],
    'estimator1__solver': ['sgd', 'adam'],
    'estimator1__alpha': [0.0001, 0.001, 0.01],
    'estimator1__learning_rate': ['adaptive'],
    'estimator1__verbose': [True]
    ...
    prediction_set1[TARGET_NAME].to_csv('out\\approach1_neural_MLP.csv', index=False)
    prediction_set1.to_csv('out\\approach1_neural_MLP_all.csv', index=False)
...
while True:
    ...
    the_pipe0 = Pipeline([
        ...
        ('estimator0', MLPRegressor()) #search solution
    ])
    ...
    param_grid0 = {
    'estimator0__activation': ['tanh', 'relu'],
    'estimator0__solver': ['sgd', 'adam'],
    'estimator0__alpha': [0.0001, 0.001, 0.01],
    'estimator0__learning_rate': ['adaptive'],
    'estimator0__verbose': [True]
    ...
    prediction_set0[TARGET_NAME].to_csv('out\\approach0_neural_MLP.csv', index=False)
    prediction_set0.to_csv('out\\approach0_neural_MLP_all.csv', index=False)
